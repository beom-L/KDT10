...
## --------------------------------------------------------------------
## - 버튼 인스턴스 생성
b1=tkinter.Button(window, text="left")
b1_1=tkinter.Button(window, text="left-1")

b2=tkinter.Button(window, text="left-2")
b2_1=tkinter.Button(window, text="left-3")

b3=tkinter.Button(window, text="left-4")
b3_1=tkinter.Button(window, text="left-5")

b4=tkinter.Button(window, text="left-6")
b4_1=tkinter.Button(window, text="left-7")

b5=tkinter.Button(window, text="center", bg='red')

## - 버튼 인스턴스를 화면에 pack 방식으로 자동 배치
## - [기본] 버튼위에 text가 보여질 만큼 W,H 크기로 버튼 배치
b1.pack(side='left')                 ## fill은 채우기 -> 없으니깐 글짜가 보일만큼만 채우기
...
# b5.pack(expand=True, fill='both')   ## both : 양쪽으로, expand : 확장해줘  -> 전체 공간 모두 사용
